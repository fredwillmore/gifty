...
class GiftsControllerTest < ActionController::TestCase
  ...
  test "should create gift" do
    assert_difference('Gift.count') do
      post :create, gift: { amount: @gift.amount, amount: @gift.amount, giver_id: @gift.giver_id, merchant_id: @gift.merchant_id, receiver_id: @gift.receiver_id }
    end
  ...
  test "should update gift" do
    patch :update, id: @gift, gift: { amount: @gift.amount, amount: @gift.amount, giver_id: @gift.giver_id, merchant_id: @gift.merchant_id, receiver_id: @gift.receiver_id }
    assert_redirected_to gift_path(assigns(:gift))
  end
